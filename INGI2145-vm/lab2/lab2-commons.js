...
var self = {
	...
	handle_request: function(db, parsed_request, res, list_of_attributes, caching_mode)
	{
		switch(parsed_request.pathname) {
			...
			case '/unenroll':
				NOMA = parsed_request.query.id
				//TODO: Invoke the unenroll (student deletion) function here!
				break;
			case '/set':
	...
	//---- Query Table for a specific user by his/her name---
        //TODO: Modify this to support caching as well --> Exercise ii
        //Refer to the queryByID function for guidance (it should work more or less the same)
	...
	//--- Delete student by his/her name---
        //TODO: Implement student deletion function --> (Exercise i)
        //TODO: Implement cache deletion feature --> (Exercise ii)
        //Note: The parameters passed to the function are just suggestions, feel free to modify them as necessary
        //Refer to: http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/Welcome.html for help
	...
	//Delete cache entry
        //TODO: Implement a cache deletion function (should be called by the caching version of unenroll student)
        //Note: The parameters passed to the function are just suggestions, feel free to modify them as necessary
        //Refer to: http://overclocked.com/mc for help
	deleteCacheEntry: function(resp, delKey)
	{
